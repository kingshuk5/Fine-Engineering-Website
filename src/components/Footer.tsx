...
const GoToTopAndWhatsAppButton: React.FC = () => {
    ...
    <div>
      {isVisible && (
        <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
          {/* WhatsApp Button */}
          <a
            href="https://wa.me/<YourPhoneNumber>?text=Hello"
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition duration-300"
            aria-label="WhatsApp Chat"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1219.547 1225.016" id="whatsapp">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" style={{ fill: "#FFFFFF" }}>
                    <path d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z"
                          className="group-hover:fill-[#171543] fill-white duration-300"></path>
                </svg>
              </div>
            </button>
          </div>
